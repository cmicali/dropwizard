...
public class ValidatingEnumParamConverterProvider<C extends Enum<C>> implements ParamConverterProvider {
    ...
    private Set<Class<C>> findEnumsUsedAsParameters(Set<Class<?>> allSingletons) {
        ...
        for (Class<?> singleton : allSingletons) {
            Method[] methods = singleton.getDeclaredMethods();
            for (Method method : methods) {
                boolean scanParameters = false;
